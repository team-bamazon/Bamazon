class ScrapingCategories
  ...
  def get_urls(products_array, nodeid, category_id)
    ...
    proxy = get_proxy
    agent2.set_proxy(proxy[:ip], proxy[:port])
  ...
  def get_and_save_product(products_array, link, category_id)
    ...
    proxy = get_proxy
    agent3.set_proxy(proxy[:ip], proxy[:port])
  ...
  def get_proxy
    proxys = [
        {ip:"187.190.221.5", port:"3129"},
        {ip:"139.59.125.12", port:"8080"},
        {ip:"122.52.49.179", port:"53281"},
        {ip:"203.170.129.56", port:"3128"},
        {ip:"201.16.227.225", port:"8080"},
        {ip:"128.199.77.93", port:"3128"},
        {ip:"186.225.114.203", port:"8080"},
        {ip:"124.122.120.44", port:"8080"},
        {ip:"139.255.101.242", port:"8080"},
        {ip:"200.54.103.76", port:"8080"},
        {ip:"182.253.6.234", port:"8080"},
        {ip:"165.227.30.203", port:"3128"},
        {ip:"95.85.50.218", port:"80"},
        {ip:"67.205.178.183", port:"55555"},
        {ip:"181.55.188.184", port:"53281"},
        {ip:"178.216.34.165", port:"53281"},
        {ip:"94.228.196.23", port:"8081"},
        {ip:"177.72.1.102", port:"8080"},
        {ip:"128.199.75.94", port:"8080"},
        {ip:"190.18.134.27", port:"8080"},
        {ip:"211.21.120.163", port:"8080"},
        {ip:"174.32.115.102", port:"87"},
        {ip:"139.59.170.92", port:"8118"},
        {ip:"202.138.254.18", port:"8080"},
        {ip:"96.94.32.50", port:"53281"},
        {ip:"189.10.5.30", port:"3128"},
        {ip:"190.186.144.121", port:"53281"},
        {ip:"139.59.165.185", port:"8118"},
        {ip:"213.111.160.200", port:"8080"},
        {ip:"87.236.194.247", port:"80"},
        {ip:"96.9.79.20", port:"55555"},
        {ip:"110.232.74.8", port:"8080"}
    ]

    ret_index = @base_proxy_index % proxys.length

    @base_proxy_index += 1

    return proxys[ret_index]
  end
end
